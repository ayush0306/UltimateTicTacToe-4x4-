...
import time
import copy
# from heurIds import Player1
from team78 import Player78
...
def gameplay(obj1, obj2):				#game simulator
	...
	while(1):
		...
		try:
			# print("trying")						#try to get player 1's move
